import copy
class DArrayHeap:
#initiate the deap, declare number of children which is d
    def __init__(self, d):
        self.items = []
        self.d = d
...
#return the partent location of the given index(child) which is i
    def get_parent(self, i):
        return (i - 1)//self.d

#get index of a parent (i) and pos of a child(0-2) and returns the child index
